...
public class GameDetailCurrent extends Activity {

    //String FILE_NAME = getResources().getString(R.string.json_file_name);

    String JSON_FILE_NAME = "currentGameSave.json";
    String jsonString;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_detail);
            ...
            try{
                ...
                JSONArray jsonScoreArray = jsonObj.getJSONArray ("score");
                ...
                tv0.setText(jsonObj.getString("playerOneName"));
                tv0.setGravity(Gravity.CENTER);
                tbRow0.addView(tv0);

                TextView tv1 = new TextView(this);
                tv1.setText( jsonObj.getString("playerTwoName"));
